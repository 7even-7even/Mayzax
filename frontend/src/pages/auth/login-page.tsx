          ...
          <div className="relative overflow-hidden rounded-[24px] border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 p-8 shadow-[0_20px_80px_rgba(42,93,168,0.08),0_0_0_1px_rgba(0,0,0,0.03)] dark:shadow-2xl">
            ...
            <div className="relative">
              <div className="mb-7">
                ...
                <h2 className="mt-4 text-[22px] font-bold tracking-tight text-slate-900 dark:text-white">Welcome back</h2>
              </div>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-5" noValidate>
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    <Input type="email" placeholder="you@mayzaxsolutions.com" className="h-[46px] pl-10 rounded-xl border-slate-200 dark:border-slate-700 bg-slate-50/70 dark:bg-slate-800/80 focus:bg-white dark:focus:bg-slate-800 focus:border-mayzax-blue-300 focus:ring-4 focus:ring-mayzax-blue-50/20 text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 text-[14px] transition-all" {...register('email')} />
                  </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <Link to="/forgot-password" className="text-xs font-semibold text-mayzax-blue-600 dark:text-mayzax-blue-400 hover:text-mayzax-blue-700 dark:hover:text-mayzax-blue-300 hover:underline">
                      Forgot?
                    </Link>
                  </div>
                  <div className="relative group">
