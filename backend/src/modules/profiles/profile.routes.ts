...
router.patch('/:id', validate({ params: idParamSchema, body: updateProfileSchema }), profileController.updateProfile);
router.patch(
  '/:id/assign',
...
router.delete('/:id', requireRole(Role.ADMIN, Role.TEAM_LEADER), validate({ params: idParamSchema }), profileController.deleteProfile);
